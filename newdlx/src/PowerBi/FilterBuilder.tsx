...
export class FilterBuilder {
    public buildReportFilters(values: IFilterValues, configuration: IFilterConfiguration): Array<models.IFilter> {
    ...
    private buildDateFilter(dateFrom: Date, dateTo: Date): pbi.models.IFilter | undefined {
    ...
    private buildProductCodeFilter(product: string): pbi.models.IFilter | undefined {
